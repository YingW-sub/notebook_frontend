export default {
  'menu.cloud': 'Notas na nuvem',
  'menu.cloudNoteGroup': 'Notas',
  'menu.cloudNoteGroup.cloudMyNotes': 'Minhas notas',
  'menu.cloudNoteGroup.cloudMyFavorites': 'Favoritos',
  'menu.cloudNoteGroup.cloudRecycle': 'Lixeira',
  'menu.cloudMyNotes': 'Minhas notas',
  'menu.cloudMyFavorites': 'Favoritos',
  'menu.cloudRecycle': 'Lixeira',
  'menu.cloudRecycleBin': 'Lixeira',
  'menu.cloudCategory': 'Categorias',
  'menu.cloudUserStats': 'Estatísticas',
  'menu.cloudStats': 'Estatísticas de dados',
  'menu.adminNoteMgmt': 'Notas',
  'menu.adminNoteMgmt.adminUserNotes': 'Notas do usuário',
  'menu.adminNoteMgmt.adminUserFavorites': 'Favoritos do usuário',
  'menu.adminUserNotes': 'Notas do usuário',
  'menu.adminUserFavorites': 'Favoritos do usuário',
  'menu.adminCategoryMgmt': 'Categorias',
  'menu.adminDataStats': 'Estatísticas',
  'menu.system': 'Sistema',
  'menu.system.admin': 'Usuários',
  'menu.system.loginLog': 'Registros de login',
  'menu.system.onlineUser': 'Usuários online',
  'menu.base': 'Dados básicos',
  'menu.base.department': 'Departamentos',
  'menu.base.departmentDetail': 'Detalhe do departamento',
  'menu.base.charts': 'Gráficos',
