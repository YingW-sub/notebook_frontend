export default {
  'menu.cloud': 'یادداشت ابری',
  'menu.cloudNoteGroup': 'یادداشت‌ها',
  'menu.cloudNoteGroup.cloudMyNotes': 'یادداشت‌های من',
  'menu.cloudNoteGroup.cloudMyFavorites': 'علاقه‌مندی‌ها',
  'menu.cloudNoteGroup.cloudRecycle': 'سطل بازیافت',
  'menu.cloudMyNotes': 'یادداشت‌های من',
  'menu.cloudMyFavorites': 'علاقه‌مندی‌ها',
  'menu.cloudRecycle': 'سطل بازیافت',
  'menu.cloudRecycleBin': 'سطل بازیافت',
  'menu.cloudCategory': 'دسته‌بندی',
  'menu.cloudUserStats': 'آمار',
  'menu.cloudStats': 'آمار داده',
  'menu.adminNoteMgmt': 'یادداشت‌ها',
  'menu.adminNoteMgmt.adminUserNotes': 'یادداشت کاربران',
  'menu.adminNoteMgmt.adminUserFavorites': 'علاقه‌مندی کاربران',
  'menu.adminUserNotes': 'یادداشت کاربران',
  'menu.adminUserFavorites': 'علاقه‌مندی کاربران',
  'menu.adminCategoryMgmt': 'دسته‌بندی',
  'menu.adminDataStats': 'آمار',
  'menu.system': 'سیستم',
  'menu.system.admin': 'کاربران',
  'menu.system.loginLog': 'گزارش ورود',
  'menu.system.onlineUser': 'کاربران آنلاین',
  'menu.base': 'داده پایه',
  'menu.base.department': 'بخش‌ها',
  'menu.base.departmentDetail': 'جزئیات بخش',
  'menu.base.charts': 'نمودارها',
