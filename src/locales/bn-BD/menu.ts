export default {
  'menu.cloud': 'ক্লাউড নোট',
  'menu.cloudNoteGroup': 'নোট',
  'menu.cloudNoteGroup.cloudMyNotes': 'আমার নোট',
  'menu.cloudNoteGroup.cloudMyFavorites': 'প্রিয়',
  'menu.cloudNoteGroup.cloudRecycle': 'রিসাইকেল বিন',
  'menu.cloudMyNotes': 'আমার নোট',
  'menu.cloudMyFavorites': 'প্রিয়',
  'menu.cloudRecycle': 'রিসাইকেল বিন',
  'menu.cloudRecycleBin': 'রিসাইকেল বিন',
  'menu.cloudCategory': 'বিভাগ',
  'menu.cloudUserStats': 'পরিসংখ্যান',
  'menu.cloudStats': 'ডেটা পরিসংখ্যান',
  'menu.adminNoteMgmt': 'নোট',
  'menu.adminNoteMgmt.adminUserNotes': 'ব্যবহারকারীর নোট',
  'menu.adminNoteMgmt.adminUserFavorites': 'ব্যবহারকারীর প্রিয়',
  'menu.adminUserNotes': 'ব্যবহারকারীর নোট',
  'menu.adminUserFavorites': 'ব্যবহারকারীর প্রিয়',
  'menu.adminCategoryMgmt': 'বিভাগ',
  'menu.adminDataStats': 'পরিসংখ্যান',
  'menu.system': 'সিস্টেম',
  'menu.system.admin': 'ব্যবহারকারী',
  'menu.system.loginLog': 'লগইন লগ',
  'menu.system.onlineUser': 'অনলাইন ব্যবহারকারী',
  'menu.base': 'মৌলিক ডেটা',
  'menu.base.department': 'বিভাগ',
  'menu.base.departmentDetail': 'বিভাগের বিবরণ',
  'menu.base.charts': 'চার্ট',
